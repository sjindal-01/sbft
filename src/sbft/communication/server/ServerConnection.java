...
*/
package sbft.communication.server;

import sbft.communication.SystemMessage;
                    ...
                    try {
                        ...
                        if (result) {
                            ...
                            if (sm.getSender() == remoteId) {
                                ...
                                /*if (!inQueue.offer(sm)) {
                                sbft.tom.util.Logger.println("(ReceiverThread.run) in queue full (message from " + remoteId + " discarded).");
