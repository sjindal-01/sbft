...
import sbft.clientsmanagement.ClientsManager;
import sbft.clientsmanagement.RequestList;
import sbft.communication.ServerCommunicationSystem;
import sbft.communication.client.RequestReceiver;
...
import sbft.statemanagement.StateManager;
...
import sbft.tom.leaderchange.RequestsTimer;
import sbft.tom.server.Recoverable;
import sbft.tom.server.RequestVerifier;
import sbft.tom.util.BatchBuilder;
import sbft.tom.util.BatchReader;
...
//            }
            ...
            if ((execManager.getCurrentLeader() == this.controller.getStaticConf().getProcessId()) && //I'm the leader
                ...
                execManager.getPCECollector().sendThresholdSigKeys(execId);
                ...
                execManager.getPCECollector().startConsensus(execId, createPropose(dec));
            }
        }
