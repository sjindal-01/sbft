...
/*******************************************7.13************************************************************/
            ...
            if (iAmLeader) {
                ...
                KeyShareMessage[] keyShareMessages = Thresig.generateKeys((controller.getCurrentViewN()) - controller.getCurrentViewF(), controller.getCurrentViewN(), me,currentCID);
                ...
                execManager.getPCECollector().setEandN(e.propValue,ee,n);
                for(int i=0;i<keyShareMessages.length;i++){
                    keyShareMessages[i].setSender(me);
                    communication.send(new int[]{i},keyShareMessages[i]);
                }
                execManager.getPCECollector().startConsensus(currentCID,e.propValue);
                /********************************************************************************************************/
