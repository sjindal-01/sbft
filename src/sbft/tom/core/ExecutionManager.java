...
import sbft.consensus.Decision;
...
public final class ExecutionManager {
    ...
    private PCECollector pceCollector; // pceCollector role
    ...
    private int commitCollector;
    private int executionCollector;
     ...
     */
    public ExecutionManager(ServerViewController controller, PCECollector pceCollector,
                            Backup backup, int me) {
        //******* EDUARDO BEGIN **************//
        this.controller = controller;
        this.backup = backup;
        this.pceCollector = pceCollector;
        //this.me = me;
        ...
        if (controller.getCurrentViewAcceptors().length > 3){
            ...
            commitCollector = controller.getCurrentViewAcceptors()[1];
            executionCollector = controller.getCurrentViewAcceptors()[2];
        }
        else {
            currentLeader = 0;
            commitCollector = 1;
            executionCollector = 2;
        }
    }
     ...
     */
    public PCECollector getPCECollector() {
        return pceCollector;
    }
...
//                        else if (msg.getType() == MessageFactory.ACCEPT) countAccepts++;
    ...
    public int getCommitCollector() {
        return commitCollector;
    }

    public void setCommitCollector(int commitCollector) {
        this.commitCollector = commitCollector;
    }

    public int getExecutionCollector() {
        return executionCollector;
    }

    public void setExecutionCollector(int executionCollector) {
